...
const MISSIONS = {
  // ── Exploração ──────────────────────────────────────────────────────
  primeiro_login:      { label: 'Primeiro acesso ao portal',    pts: 2,   icon: 'fa-door-open',         cor: '#818cf8', desc: 'Acesse o portal pela primeira vez',              categoria: 'Exploração' },
  ver_fatura:          { label: 'Verificar suas faturas',        pts: 2,   icon: 'fa-file-invoice',       cor: '#22d3ee', desc: 'Visite a seção de faturas',                     categoria: 'Exploração' },
  ver_conexao:         { label: 'Verificar sua conexão',         pts: 2,   icon: 'fa-wifi',               cor: '#4ade80', desc: 'Acesse a tela Minha Conexão',                  categoria: 'Exploração' },
  explorador:          { label: 'Explorador do portal',          pts: 10,  icon: 'fa-compass',            cor: '#c084fc', desc: 'Visite todas as seções do portal',              categoria: 'Exploração' },
  ver_velocidade_sec:  { label: 'Visitar Teste de Velocidade',   pts: 2,   icon: 'fa-gauge-high',         cor: '#a78bfa', desc: 'Acesse a seção de Teste de Velocidade',         categoria: 'Exploração' },
  ver_perfil_sec:      { label: 'Visitar seu perfil',            pts: 2,   icon: 'fa-user-circle',        cor: '#38bdf8', desc: 'Acesse a seção Meu Perfil',                    categoria: 'Exploração' },
  ver_suporte_sec:     { label: 'Visitar seção de suporte',      pts: 2,   icon: 'fa-life-ring',          cor: '#fb923c', desc: 'Acesse a área de suporte e chamados',           categoria: 'Exploração' },
  ver_clube:           { label: 'Visitar o Lemon Club',          pts: 2,   icon: 'fa-star',               cor: '#a3e635', desc: 'Acesse a área do Lemon Club',                   categoria: 'Exploração' },
  ver_desafios:        { label: 'Ver seus desafios',             pts: 2,   icon: 'fa-list-check',         cor: '#c084fc', desc: 'Acesse a aba de Desafios no Lemon Club',        categoria: 'Exploração' },
  ver_historico:       { label: 'Ver histórico de pontos',       pts: 2,   icon: 'fa-clock-rotate-left',  cor: '#67e8f9', desc: 'Confira seu histórico de pontos ganhos',        categoria: 'Exploração' },
  acesso_noturno:      { label: 'Acesso noturno',                pts: 3,   icon: 'fa-moon',               cor: '#818cf8', desc: 'Acesse o portal após as 22h',                  categoria: 'Exploração' },
  ...
  maratonista:         { label: '15 faturas em dia',             pts: 250, icon: 'fa-person-running',     cor: '#f59e0b', desc: 'Total de 15 faturas pontuadas como pagas no prazo.', categoria: 'Fidelidade', auto: true },
  ...
  streak_18:           { label: '18 faturas em dia',             pts: 300, icon: 'fa-gem',                cor: '#a78bfa', desc: 'Total de 18 faturas pontuadas como pagas no prazo.', categoria: 'Fidelidade', auto: true },
  streak_24:           { label: '24 faturas em dia',             pts: 350, icon: 'fa-trophy',             cor: '#f59e0b', desc: 'Total de 24 faturas pontuadas como pagas no prazo.', categoria: 'Fidelidade', auto: true },
